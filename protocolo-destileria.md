...
El esqueleto argumental completo: tesis central, argumentos de soporte, arquitectura de capítulos, transiciones. ¿Es el casco robusto o quebradizo? ¿Hay órganos atrofiados o contradicciones no controladas? Identifica los conceptos sin los cuales el barco colapsa. Emite certificado de navegabilidad estructural.

**Estrato 2 — Corrientes y Vientos**
*Las fuerzas externas que empujan el barco aunque el capitán no las vea*
Los vectores históricos, sociales, psicológicos y políticos que moldean el argumento desde adentro aunque no se mencionen. Mapea las tensiones internas — ¿son accidentales o esenciales? Identifica los puntos de inflexión: las bifurcaciones donde el capitán eligió un rumbo y abandonó otro.

**Estrato 3 — Arquitectura Naval**
*Los patrones de construcción, las simetrías y los desequilibrios reveladores*
La geometría profunda que estructura el texto más allá de la consciencia del autor. Examina las asimetrías reveladoras: ¿por qué tres capítulos a un tema y tres párrafos a otro igualmente importante? ¿Qué perspectivas están ausentes? Distingue paradojas productivas de paradojas que revelan simple confusión.

**Estrato 4 — Aguas Profundas**
*La ontología, la ética y las verdades que el texto no puede nombrar sin hundirse*
La ontología implícita: ¿qué asume el texto sobre la naturaleza fundamental de la realidad? La epistemología: ¿cómo sabe lo que afirma saber? La ética: ¿qué valores subyacen, incluso los que el autor negaría? Las sombras no reconocidas: ¿qué verdades debe evitar para mantener su coherencia superficial?

**Estrato 5 — El Capitán y su Sombra**
*Las proyecciones, obsesiones y arquetipos que el autor navega sin saberlo*
Las proyecciones: ¿qué fantasías deposita el autor creyendo que describe el mundo? Los mecanismos de defensa retóricos: intelectualización, racionalización, formación reactiva, proyección. Los arquetipos que emergen sin ser invocados. Las repeticiones compulsivas: patrones que el texto reproduce obsesivamente.
...
**Sinopsis del Viaje** — 300 a 400 palabras en prosa literaria no expositiva. Captura lo esencial: las grietas más importantes, la carga real versus la declarada, lo que el capitán no sabe que está navegando. Sin eufemismos, sin crueldad innecesaria.
...
La lectura alegórica. Símbolos, metáforas estructurales, imágenes recurrentes. Para cada imagen central: el espectro de lecturas que activa simultáneamente — psicológica, cultural, mítica, política. Las tensiones entre lecturas alegóricas que apuntan en direcciones contradictorias.

**Lente 3 — Lo que exige**
La lectura moral. No la ética declarada — la ética implícita. ¿Qué le pide el corpus al lector? ¿Cuándo lo que exige explícitamente contradice lo que exige implícitamente? ¿A quién le exige qué según género, clase, cultura, época?
...
- **Núcleo principal** — el concepto con mayor gravitación, estimado cualitativamente
