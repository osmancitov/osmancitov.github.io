...
|----|--------|----------|-----------------|
| M1 | Escucha | Apolíneo | Cadena secuencial sin contexto previo. El corpus se declara a sí mismo. |
| M2 | Umbral | Marco | Condición de operación. Geometría de tres fuerzas en tensión. |
| M3 | Objeto | Material | El corpus como cosa física antes de la primera página. |
| M4 | Recepción | Orientación | Ficha técnica, sinopsis, tensiones centrales. El instrumento más transferible. |
| M5 | Análisis por secciones | Granular | Joyas en tres escalas: microscópica, mesoscópica, macroscópica. |
| M6 | Inspección | Veredicto | Seis miradas estructurales. El único instrumento que juzga explícitamente. |
| M7 | Laboratorio | Sintomático | Lo que el corpus no sabe que contiene. Cuatro lentes. La semilla. |
| M8 | Etiquetado | Identidad | Cierre con identidad, no con resumen. El imán conceptual. La sentencia final. |
| M9 | Síntesis | Total | El análisis se ve a sí mismo como unidad. Declara o niega el palimpsesto. |
...
**Sobre la selección**
No hay secuencia obligatoria. M1 puede revelar qué instrumentos tienen sentido con un corpus específico — su Paso 6 produce exactamente eso. Para un corpus desconocido, M1 o M4 son entradas naturales. Para análisis estructural directo, M12. Para el pulso, M13.
