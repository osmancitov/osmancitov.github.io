...
Cuando este protocolo opera sobre el conjunto de resultados de múltiples instrumentos aplicados a un mismo corpus — en lugar de sobre el corpus directamente — el protocolo se amplía con los siguientes criterios.
