# Imágenes — Destilería Osmancito

---

## 1. Frase de Recepción del Objeto
...
Justo debajo del encabezado principal, antes del Registro de Entrada y antes del índice de contenido.

Su propósito es distinto al resto: no encarna la atmósfera del libro analizado, sino que imagina el *objeto físico del producto de la Destilería* como si fuera él mismo un libro publicado. Un libro sobre el libro. Una obra derivada que existe en el mundo.
...
*Los estilos pictóricos posibles incluyen — sin limitarse a — ilustración editorial, grabado, acuarela, óleo, gouache, tinta, woodcut, litografía, pastel seco, collage analógico. El corpus dicta cuál conviene.*
