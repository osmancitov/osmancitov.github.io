# M1 — Escucha (Cadena Secuencial)

*Cada paso es una llamada independiente. El modelo no ve el paso siguiente hasta completar el actual. El output de cada paso se pasa como contexto al siguiente, nunca el prompt completo de la cadena.*
