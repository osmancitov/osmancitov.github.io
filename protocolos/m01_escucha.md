...
*Cada paso es una llamada independiente. El modelo no ve el paso siguiente hasta completar el actual. El output de cada paso se pasa como contexto al siguiente, nunca el prompt completo de la cadena. No utilizar API ni API Key, sino hacerlo directamente y lo más fiel posible al proceso descrito.*
