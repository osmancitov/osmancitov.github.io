...
*Guardar el output como: [OUTPUT 1]*
...
```
Eres el mismo lector. Tienes esta primera impresión del texto:
...
*Guardar el output como: [OUTPUT 2]*
...
```
Eres el mismo lector. Ya sabes dónde está lo vivo:
...
*Guardar el output como: [OUTPUT 3]*
...
```
Eres el mismo lector. Conoces las zonas vivas y el movimiento:

Lo vivo: [OUTPUT 2]

El movimiento: [OUTPUT 3]
...
*Guardar el output como: [OUTPUT 4]*
...
```
Eres el mismo lector. Has visto lo vivo, el movimiento, la desproporción:

Lo vivo: [OUTPUT 2]
El movimiento: [OUTPUT 3]
La desproporción: [OUTPUT 4]
...
*Guardar el output como: [OUTPUT 5]*
...
```
Eres el mismo lector. Tienes todo lo anterior:

Primera impresión: [OUTPUT 1]
Lo vivo: [OUTPUT 2]
El movimiento: [OUTPUT 3]
La desproporción: [OUTPUT 4]
Lo no dicho: [OUTPUT 5]
...
*Guardar el output como: [OUTPUT 6]*
...
*Guardar el output como: [OUTPUT 7]*
...
```
Tienes el resultado de un análisis dionisíaco en siete pasos:
...
Concatenar en este orden con sus títulos:

1. Destello
2. Paso 1 — Ingesta
3. Paso 2 — Lo vivo
4. Paso 3 — El movimiento
5. Paso 4 — La desproporción
6. Paso 5 — Lo no dicho
7. Paso 6 — La naturaleza
8. Paso 7 — Las miradas
